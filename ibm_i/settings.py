"""
Django settings for ibm_i project.
...
SECRET_KEY = 'django-insecure-v#0!u8b9ferplcw!ed2muhmr8@=&*$c!d9ogi4c=zad1ef0e+t'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['192.168.8.220']
...
WSGI_APPLICATION = 'ibm_i.wsgi.application'
...
# IBM Server Credentials

IBM_SCHEMA = os.getenv("SCHEMA")
IBM_DB_NAME = os.getenv("DATABASE")
IBM_USERNAME = os.getenv("USERNAME")
IBM_PASSWORD = os.getenv("PASSWORD")